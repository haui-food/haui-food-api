...
const getCartDetailById = catchAsync(async (req, res) => {
  const cartDetail = await cartDetailService.getCartDetailById(req.params.cartDetailId);
...
const updateCartDetail = catchAsync(async (req, res) => {
  const cartDetail = await cartDetailService.updateCartDetailById(req.params.cartDetailId, req.body);
...
const deleteCartDetail = catchAsync(async (req, res) => {
  const cartDetail = await cartDetailService.deleteCartDetailById(req.params.cartDetailId);
